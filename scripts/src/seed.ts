...
async function seed() {
  ...
  await db.insert(captionsTable).values([
    { niche: "Fashion", platform: "Instagram", tone: "Promotional", type: "New Arrival", category: "Product Launch", text: "✨ New Drop Alert! Our latest collection just landed and it is EVERYTHING. Elevate your wardrobe game with pieces crafted for the bold, the chic, and the unapologetically stylish. Shop now — these go fast! 👗🔥 #FashionForward #NewCollection #StyleGoals #OOTDInspo #ShopNow", usageCount: 12, sellerRef: "default" },
    { niche: "Fashion", platform: "WhatsApp", tone: "Urgent", type: "Flash Sale", category: "Sale", text: "Hi sis! 👋 Quick heads up — we have a FLASH SALE running right now on selected fashion pieces! Prices slashed for the next 24 hours only. Reply SHOP to browse our hot deals. Don't sleep on this! 🔥", usageCount: 8, sellerRef: "default" },
    { niche: "Hair", platform: "Instagram", tone: "Luxury", type: "New Arrival", category: "Product Launch", text: "Quality that speaks for itself 💎 Our Brazilian Body Wave bundles are hand-selected, tangle-free, and absolutely luxurious. Because your hair deserves nothing less than the best. Available in multiple lengths — shop via link in bio 🌟 #HairGoals #BrazilianHair #LuxuryHair #Weave #VirginHair", usageCount: 25, sellerRef: "default" },
    { niche: "Hair", platform: "TikTok", tone: "Funny", type: "Promotional", category: "Social Media", text: "POV: You found the wig that slays every single time 😂💃 Our lace front wigs are giving EVERYTHING. No glue drama, no bad wig days — just pure excellence. DM to order! #WigLife #HairTok #BlackGirlMagic #WigInstall #fyp", usageCount: 31, sellerRef: "default" },
    { niche: "Food", platform: "Instagram", tone: "Storytelling", type: "Promotional", category: "Brand", text: "Every dish tells a story. 🍲 This one started with a family recipe passed down for generations — now it lands on your table, made with the same love and the freshest ingredients. Taste the difference quality makes. Order now via link in bio! 🌿", usageCount: 7, sellerRef: "default" },
    { niche: "Food", platform: "Facebook", tone: "Emotional", type: "New Arrival", category: "Product Launch", text: "There is nothing quite like a home-cooked meal — except when it is made with love AND delivered to your door. We pour our heart into every order because food should make you feel something. Try our new menu today. You deserve it. 💛", usageCount: 4, sellerRef: "default" },
    { niche: "Jewellery", platform: "Instagram", tone: "Luxury", type: "New Arrival", category: "Product Launch", text: "Handcrafted to perfection 💍✨ Our newest jewellery collection is here — each piece designed to tell your story. From delicate everyday rings to statement necklaces that command attention. You were born to sparkle. Shop the collection via link in bio. #Jewellery #HandcraftedJewelry #GoldJewelry", usageCount: 19, sellerRef: "default" },
    { niche: "Beauty", platform: "Instagram", tone: "Educational", type: "Promotional", category: "Educational", text: "Did you know? The right skincare routine can transform your skin in 30 days 🌿✨ Our curated Beauty Starter Kit includes everything you need: cleanser, toner, moisturizer, and SPF. Dermatologist-approved and suitable for all skin types. Link in bio to shop 💆‍♀️ #SkincareTips #BeautyRoutine #GlowUp", usageCount: 14, sellerRef: "default" },
    { niche: "Fashion", platform: "Facebook", tone: "Emotional", type: "Promotional", category: "Brand", text: "Fashion is not just about clothes — it is about confidence. It is walking into a room and knowing you look amazing. Our collection was designed for moments like that. Women who know their worth. Shop the new arrivals and wear your confidence 💫", usageCount: 6, sellerRef: "default" },
    { niche: "Hair", platform: "WhatsApp", tone: "Urgent", type: "Restock", category: "Product Launch", text: "Hi beautiful! Your fave Brazilian bundles are BACK IN STOCK 🙌 We sold out in 48 hours last time — this restock is even bigger but won't last long. Reply NOW to reserve yours before they fly. Limited bundles available. Thank you for your patience and support 🙏", usageCount: 22, sellerRef: "default" },
    { niche: "Beauty", platform: "TikTok", tone: "Funny", type: "Promotional", category: "Social Media", text: "Me before this skincare kit: 😩 Me after: ✨👸 I am not saying it's magic but... it might be magic. Our Glow Up Kit is the real deal and it ships to your city! DM us to order. #SkincareRoutine #GlowUp #BeautyTok #SkinTok #fyp", usageCount: 41, sellerRef: "default" },
    { niche: "Jewellery", platform: "WhatsApp", tone: "Luxury", type: "Promotional", category: "Engagement", text: "Good evening! 💍\n\nWe wanted to share something beautiful with you — our new 18K gold-plated Crystal Collection has arrived.\n\nEvery piece is handcrafted, hypoallergenic, and comes gift-wrapped.\n\nPerfect for treating yourself or someone special.\n\nReply to see the full collection 🌟", usageCount: 9, sellerRef: "default" },
  ]).onConflictDoNothing();
